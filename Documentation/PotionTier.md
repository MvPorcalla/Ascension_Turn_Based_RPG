=== EARLY GAME (Tutorial Area) ===
Beginner Health Potion:        50 HP flat (easy to understand)
Minor Health Potion:            20% HP (scales)

=== MID GAME ===
Health Potion:                  50% HP
Greater Health Potion:          100% HP (full heal)

=== REJUVENATION (Over Time) ===
Minor Rejuvenation:             20% over 3 turns
Rejuvenation Potion:            40% over 4 turns
Greater Rejuvenation:           60% over 5 turns

=== SPECIAL/QUEST ITEMS ===
Emergency Flask:                100 HP flat (quest reward)
Commander's Ration:             200 HP flat (army supplies)
Ancient Elixir:                 500 HP flat (rare drop)
