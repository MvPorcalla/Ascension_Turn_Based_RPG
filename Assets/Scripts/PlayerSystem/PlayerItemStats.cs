...
{
    // Serializable backing fields for Unity Inspector/JSON
    ...
    // Runtime dictionary for flexible access
    ...
    // Dictionary-style access (Best of both worlds)
    ...
    // Direct property access for PlayerDerivedStats
    public float AD => ad;
    public float AP => ap;
    public float HP => hp;
