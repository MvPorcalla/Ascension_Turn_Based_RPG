...
// Keeps ScriptableObjects pure by separating test logic
// ════════════════════════════════════════════
...
namespace Ascension.Editor
{
    ...
    public static class ItemSODebugger
    {
        ...
        private static void AddToBag()
        {
            ...
            invMgr.AddItem(item.ItemID, quantity, addToBag: true);
        ...
        private static void AddToStorage()
        {
            ...
            invMgr.AddItem(item.ItemID, quantity, addToBag: false);
