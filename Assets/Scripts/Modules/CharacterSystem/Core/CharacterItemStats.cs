// ════════════════════════════════════════════════════════════════════════
// Assets/Scripts/CharacterSystem/Core/CharacterItemStats.cs
// Holds item-based stat bonuses for characters
// ════════════════════════════════════════════════════════════════════════
...
namespace Ascension.Character.Core
{
    ...
    public class CharacterItemStats
    {
        ...
        [NonSerialized] private Dictionary<BonusStatType, float> statsCache;
